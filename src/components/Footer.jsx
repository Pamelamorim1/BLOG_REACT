...
export default function Footer() {
    ...
    const socialLinks = {
        ...
        email: "mailto:clinicalove.esthetic@gmail.com?subject=Agendamento de Consulta&body=Gostaria de saber mais informações sobre os horários disponíveis para agendamento.",
        ...
        <footer className="mt-auto">
            ...
            <div className="bg-slate-800 text-slate-400">
                <div className="container mx-auto px-4 py-4 text-center text-sm">
                    <p>© {currentYear} Dr. Ana Carla Gomes. Todos os direitos reservados.</p>
                </div>
            </div>
        </footer>
    );
